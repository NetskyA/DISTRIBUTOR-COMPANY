...
export default function RegisterUser() {
    ...
    async function register() {
        ...
        if (username == "" || password == "" || alamat == "" || nohp == "" || email == "" || rekening == "" || (!salesman && !supervisor && !ksupervisor)) {
            ...
            // setNewUser(user.data[user.length-1])
        }
    }
            ...
            <div className="selectdisable w-2/5 border-2 mt-10 flex rounded-2xl h-full" style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                <div className="row ms-4 m-4 w-full">
                    <div className="MSales flex text-primary  text-2xl">
                        ...
                        <input type="text" placeholder="Username" className="border border-primary rounded-lg w-1/2 text-xl h-10" name="username" id="username" />
                    </div>
                    <div className="noId flex  mt-3  text-primary text-2xl">
                        <p className="pt-1 w-52 pr-2">Password : </p>
                        <input type="text" placeholder="Password" className="border border-primary rounded-lg w-1/2 text-xl h-10" name="password" id="password" />
                    </div>
                    ...
                    <div className="PhoneNumber flex mt-3 text-primary  text-2xl">
                        ...
                        <input type="number" placeholder="No. Hp" required="number" className="border border-primary rounded-lg w-64 text-xl h-10" name="nohp" id="nohp" />
                    </div>
                    ...
                    <div className="PhoneNumber flex mt-3 text-primary  text-2xl">
                        ...
                        <input type="number" placeholder="No. Rekening" required="number" className="border border-primary rounded-lg w-64 text-xl h-10" name="rekening" id="rekening" />
                    </div>

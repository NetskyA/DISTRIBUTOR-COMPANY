                                                ...
                                                {toko.map((t)=>{
                                                    return <tr className="border-b dark:border-neutral-500">
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <p>
                                                                <input type="text" name="" className="border-primary rounded-lg text-2xl" id={`nama_toko${t.id_toko}`}
                                                                value={t.nama_toko}
                                                                onChange={(e) =>
                                                                    handleInputChange(
                                                                        e,
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <p>
                                                                <input type="text" name="" className="border-primary rounded-lg text-2xl" id={`nama_konsumen${t.id_toko}`}
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <p>
                                                                <input type="text" name="" className="border-primary rounded-lg text-2xl" id={`alamat_toko${t.id_toko}`}
                                                                value={t.alamat_toko}
                                                                onChange={(e) =>
                                                                    handleInputChange(
                                                                        e,
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <p>
                                                                <input type="text" name="" className="border-primary rounded-lg text-2xl" id={`no_handphone1${t.id_toko}`}
                                                        ...
                                                        <td className="whitespace-nowrap px-6 py-4">
                                                            <p>
                                                                <input type="text" name="" className="border-primary rounded-lg text-2xl" id={`no_handphone2${t.id_toko}`}

...
export default function ReturnBarang(){
    ...
    return(
        <>
            ...
            <div className="selectdisable border-2 mt-10 flex border-gray-300 rounded-2xl w-5/12 h-full" style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                {/* berisi from retur */}
            ...
            <div className="mt-5 mb-48 w-full mx-auto">
                <table className="text-left text-2xl font-light border rounded-xl w-9/12">
                ...
                <div className="flex">
                    <div className="w w-full mt-10 mb-5">
                        <button onClick={test} className="bg-primary w-52 h-16 rounded-xl hover:bg-slate-400 text-white hover:text-white font-bold py-2 px-4">
                            Submit
                        </button>
                    </div>

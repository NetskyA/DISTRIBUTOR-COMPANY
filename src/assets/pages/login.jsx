...
import LogoLogin from "../images/image-login/draw.png";
        ...
        <> < div className = "cover mx-auto bg-white"> <section className="h-screen">
            <div className="container h-full px-6 py-24">
                <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-6/12" data-aos="fade-right" data-aos-duration="800">
                        <img
                            src={LogoLogin}
                            className="w-full"
                            alt="Phone image"/>
                    ...
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12" data-aos="fade-up" data-aos-duration="800">
                        <div className="cover">
